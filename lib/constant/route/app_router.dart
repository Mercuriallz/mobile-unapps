...
import 'package:mobile_unapps/presentation/auth/login/login_page.dart';
...
GoRoute(path: '/order', builder: (context, state) => const OrderInitialPage()),
GoRoute(path: '/order/membership', builder: (context, state) => const UninetMembershipPage()),
